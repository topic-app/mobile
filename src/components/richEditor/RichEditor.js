...
export default class RichTextEditor extends Component {
  ...
  constructor(props) {
    ...
    that.state = {
      html: {
        html:
          html || createHTML({ backgroundColor, color, placeholderColor, cssText, contentCSSText }),
      },
      keyboardHeight: 0,
      height: 0,
      isInit: false,
  ...
  onMessage(event) {
    try {
      ...
      switch (message.type) {
        ...
        case messages.CONTENT_CHANGE_MARKDOWN: {
          this.props.onChangeMarkdown && this.props.onChangeMarkdown(message.data);
          break;
        }
