  ...
  return (
    <View>
      ...
      <View style={styles.contentContainer}>
        <Divider />
        <PlatformTouchable onPress={() => handleUrl('https://mgen.fr')}>
          ...
          <Text>
            Plus d&apos;infos sur <Text style={styles.link}>mgen.fr</Text>
          </Text>
        </PlatformTouchable>
        <Divider style={{ marginTop: 20 }} />
        <PlatformTouchable onPress={() => handleUrl('https://edtechfrance.fr')}>
          <View style={[styles.centerImageContainer, { marginTop: 60, marginBottom: 10 }]}>
          ...
          <Text>
            Plus d&apos;infos sur <Text style={styles.link}>edtechfrance.fr</Text>
          </Text>
        </PlatformTouchable>
        <Divider style={{ marginTop: 20 }} />
        <PlatformTouchable onPress={() => handleUrl('https://instagram.com/jtacasso')}>
          <View style={[styles.centerImageContainer, { marginTop: 60, marginBottom: 10 }]}>
          ...
          <Text>
            ...
            qui s’aligne parfaitement avec les buts de notre application, et nous avons donc décidé
            de développer l’application en partenariat avec celle-ci.
          </Text>
        </PlatformTouchable>
        <Divider style={{ marginTop: 20 }} />
        <PlatformTouchable onPress={() => handleUrl('https://lesper.fr')}>
          ...
          <Text>
            Plus d&apos;infos sur <Text style={styles.link}>lesper.fr</Text>
          </Text>
        </PlatformTouchable>
      </View>
    </View>
