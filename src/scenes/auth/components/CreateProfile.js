  ...
  validateFirstnameInput = () => {
    ...
    if (firstname !== '') {
      if (firstname.match(/^[a-zA-Z0-9_ ]*$/i) === null) {
        this.setState({ firstnameValid: false, firstnameError: true, firstnameErrorMessage: "Votre prénom ne peut pas contenir de caractères spéciaux"})
      } else {
  ...
  validateLastnameInput = () => {
    ...
    if (lastname !== '') {
      if (lastname.match(/^([0-9]|[a-z])+([0-9a-z]+)$/i) === null) {
        this.setState({ lastnameValid: false, lastnameError: true, lastnameErrorMessage: "Votre nom ne peut pas contenir de caractères spéciaux" });
      } else {
